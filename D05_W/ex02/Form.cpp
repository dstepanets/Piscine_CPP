...
Form::NotSignedException::NotSignedException(NotSignedException const &src) {*this = src;}
Form::NotSignedException::~NotSignedException(void) throw() {}
Form::NotSignedException 
			&Form::NotSignedException::operator = 
			(Form::NotSignedException const &rhs)
			{std::exception::operator=(rhs); return *this;}

const char *		Form::NotSignedException::what(void) const throw()
{
	return ("Form execution error: The form is not signed and can't be executed.");
}
